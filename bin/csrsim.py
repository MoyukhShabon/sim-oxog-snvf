...
## This script uses wgsim to make simulated paired-end reads with four haplotypes (two normal and two cancer) from a reference genome.
## The levels of cancer purity, genuine mutation rate, coverage, and base error rate and be defined with their respective arguments.
...
if __name__ == "__main__":
    ...
    ## This is the base command for wgsim, others be appended to it
    cmd_base = [
        wgsim,
        "-e", str(berror),
        "-d", str(isize),
    ...
    # Setting file names and number of reads and appending to the base command
